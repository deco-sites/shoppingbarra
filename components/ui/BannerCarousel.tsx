...
function BannerItem({ image, lcp }: { image: Banner; lcp?: boolean }) {
  ...
  return (
    <a
      ...
      class="relative h-auto overflow-y-hidden  "
    >
      <Picture preload={lcp}>
        <Source
...
function BannerCarousel({ images, preload, interval }: Props) {
  ...
  return (
    <div class="flex justify-center">
      <div
        id={id}
        class="grid grid-cols-[48px_1fr_48px] sm:grid-cols-[120px_1fr_120px] grid-rows-[1fr_48px_1fr_64px] max-h-[39rem] max-w-[90rem]"
      >
        ...
        {qtdImages > 1 &&
          (
            <>
              ...
              <SliderJS
                rootId={id}
                interval={interval && interval * Number(1 + "e" + qtdImages)}
                infinite
              />
            </>
          )}
